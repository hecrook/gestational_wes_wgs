#!/bin/bash
# This script is for filtering out germline variants from tumour vcfs that have been fitlered using all germline samples available.
...
for sample in $@; do
	...
	tumvcf="${sample}.germfiltered.hcfiltered2wgs.mutect2.filtered.vcf"
	...
	output="/data/scratch/DMP/UCEC/EVOLIMMU/hcrook/gestational_WES_WGS/results/gnomad_filterVCF/$sample.gnomad.genomes.af0001.germfiltered.hcfiltered2wgs.filtered.vcf"
	# main command 
