...
for sample in $@; do
	...
	tumvcf="${sample}.matfiltered.hcfiltered2wgs.mutect2.filtered.vcf"
	...
	output="/data/scratch/DMP/UCEC/EVOLIMMU/hcrook/gestational_WES_WGS/results/gnomad_filterVCF/$sample.gnomad.genomes.af0001.matfiltered.hcfiltered2wgs.filtered.vcf"
	# main command 
