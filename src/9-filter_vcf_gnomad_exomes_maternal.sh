...
for sample in $@; do
	...
	output="/data/scratch/DMP/UCEC/EVOLIMMU/hcrook/gestational_WES_WGS/results/gnomad_filterVCF/$sample.gnomad.exomes.af0001.matfiltered.hcfiltered2.filtered.vcf"
	# main command 
