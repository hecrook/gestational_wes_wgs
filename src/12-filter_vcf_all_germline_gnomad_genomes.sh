...
for sample in $@; do
	...
	output="/data/scratch/DMP/UCEC/EVOLIMMU/hcrook/gestational_WES_WGS/results/gnomad_filterVCF/$sample.gnomad.genomes.af0001.germfiltered.hcfiltered2.filtered.vcf"
	# main command 
